defmodule ScopesAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ScopesAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ScopesAppWeb.Gettext, "errors", msg, opts)
    end
  end
